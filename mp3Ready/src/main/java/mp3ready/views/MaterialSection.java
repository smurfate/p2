...
public class MaterialSection implements View.OnTouchListener,
	...
	public MaterialSection(Context ctx, int iconType, int target) {
		...
		case ICON_NO_ICON:
			/*
			 * view =
			 * LayoutInflater.from(ctx).inflate(R.layout.layout_material_section
			 * , null);
			 * 
			 * text = (TextView) view.findViewById(R.id.section_text);
			 * notifications = (TextView)
			 * view.findViewById(R.id.section_notification);
			 */
			break;
		case ICON_24DP:
		...
		case ICON_40DP:
			/*
			 * view = LayoutInflater.from(ctx).inflate(R.layout.
			 * layout_material_section_icon_large, null);
			 * 
			 * text = (TextView) view.findViewById(R.id.section_text); icon =
			 * (ImageView) view.findViewById(R.id.section_icon); notifications =
			 * (TextView) view.findViewById(R.id.section_notification);
			 */break;
		}
		...
		try {
			...
			colorUnpressed = values.getColor(
					R.styleable.MaterialSection_sectionBackgroundColor,
					0x00FFFFFF);
			...
			notificationColor = values
					.getColor(
							R.styleable.MaterialSection_sectionColorNotification,
							0x000);
...
//				UtilClass.setAlpha(icon, 1f);
		...
		// se la sezione ha come target l'activity, dopo che questa viene
		// avviata si deseleziona.
