...
public class OkHttpDownloader implements Downloader {
	public static final String TAG = OkHttpDownloader.class.getName();
	private Context context;

	private static OkHttpClient defaultOkHttpClient() {
		OkHttpClient.Builder builder = new OkHttpClient.Builder();
		builder.connectTimeout(Utils.DEFAULT_CONNECT_TIMEOUT_MILLIS,
				TimeUnit.MILLISECONDS);
		builder.readTimeout(Utils.DEFAULT_READ_TIMEOUT_MILLIS,
				TimeUnit.MILLISECONDS);
		builder.writeTimeout(Utils.DEFAULT_WRITE_TIMEOUT_MILLIS,
				TimeUnit.MILLISECONDS);
	...
	public OkHttpDownloader(final Context context) {
		this(Utils.createDefaultCacheDir(context), context);
	}
	 ...
	 */
	public OkHttpDownloader(final File cacheDir, Context context) {
		this(cacheDir, Utils.calculateDiskCacheSize(cacheDir), context);
	}
	...
	public OkHttpDownloader(final Context context, final long maxSize) {
		this(Utils.createDefaultCacheDir(context), maxSize, context);
	}
