 ...
 * Original file: D:\\Documents\\Android\\Mp3Ready\\mp3Ready\\src\\main\\aidl\\mp3ready\\download\\services\\IDownloadService.aidl
 */
package mp3ready.download.services;
public interface IDownloadService extends android.os.IInterface
{
/** Local-side IPC implementation stub class. */
public static abstract class Stub extends android.os.Binder implements mp3ready.download.services.IDownloadService
{
private static final java.lang.String DESCRIPTOR = "mp3ready.download.services.IDownloadService";
...
/**
 * Cast an IBinder object into an mp3ready.download.services.IDownloadService interface,
 * generating a proxy if needed.
 */
public static mp3ready.download.services.IDownloadService asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof mp3ready.download.services.IDownloadService))) {
return ((mp3ready.download.services.IDownloadService)iin);
}
return new mp3ready.download.services.IDownloadService.Stub.Proxy(obj);
}
...
private static class Proxy implements mp3ready.download.services.IDownloadService
{
...
@Override public void addTask(java.lang.String url, java.lang.String title) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
public void addTask(java.lang.String url, java.lang.String title) throws android.os.RemoteException;
